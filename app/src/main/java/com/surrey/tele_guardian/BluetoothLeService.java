...
public class BluetoothLeService extends Service {
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        Log.d(TAG, "readCharacteristic called.");
    }

    public boolean writeCharacteristic(byte data) {

        BluetoothGattCharacteristic charac = getCharacteristic();
        byte[] value = new byte[1];
        value[0] = (byte) (data);
        charac.setValue(value);
        boolean status = mBluetoothGatt.writeCharacteristic(charac);
        Log.d(TAG, "Sent message " + data + " with status = " + status);
        return status;
    }
    ...
    public BluetoothGattCharacteristic getCharacteristic() {
        ...
        UUID uuid = Service.getCharacteristics().get(0).getUuid();
